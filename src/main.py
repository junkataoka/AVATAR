...
parser.add_argument('--data_path', type=str, default="home/kataokaj/scratch/AVATAR/data", help='data path')
...
def main(args):
    ...
    model = MyResNet50(n_class=args.num_classes).to(args.device)
    ...
    # define optimizer 
    params_enc = get_params(model, ["conv1", "bn1", "relu", "maxpool", "layer1", "layer2", "layer3", "layer4", "avgpool"])
    params_cls = get_params(model, ["fc1", "fc2"])
    optimizer_dict = {
