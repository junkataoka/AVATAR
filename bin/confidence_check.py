...
home_dir = "/data/home/jkataok1/AVATAR"
...
axs[0].set_ylabel('Accuracy (%)', fontsize=label_size)
...
axs[2].set_ylabel('Accuracy (%)', fontsize=label_size)
...
axs[2].set_yticks(np.arange(0.0, 1.1, 0.1))
axs[2].set_ylim(0, 1)
...
## ax2.set_title(r'Accuracy across 31 classes', fontsize=16)
#
